...
public class CalendarAdapter extends RecyclerView.Adapter<CalendarAdapter.CalendarDayViewHolder> {
    ...
    public List<CalendarDay> getDays() {
        return new ArrayList<>(calendarDays);
    }
    ...
    public class CalendarDayViewHolder extends RecyclerView.ViewHolder {        private CardView cardView;
        private TextView tvSolarDay;
        private TextView tvLunarDay;
        private TextView tvCanChi;
        private View viewHolidayIndicator;
        private View viewEventIndicator;
        ...
        public CalendarDayViewHolder(@NonNull View itemView) {
            ...
            viewEventIndicator = itemView.findViewById(R.id.viewEventIndicator);
        ...
        public void bind(CalendarDay day, int position) {
            ...
            try {
                ...
                // Hiển thị chỉ báo sự kiện
                setEventIndicator(day);
        ...
        private void setEventIndicator(CalendarDay day) {
            if (viewEventIndicator == null) return;

            try {
                if (day.hasEvents && day.isCurrentMonth) {
                    viewEventIndicator.setVisibility(View.VISIBLE);
                } else {
                    viewEventIndicator.setVisibility(View.GONE);
                }
            } catch (Exception e) {
                Log.e(TAG, "Error setting event indicator: " + e.getMessage());
                viewEventIndicator.setVisibility(View.GONE);
            }
        }
    }
